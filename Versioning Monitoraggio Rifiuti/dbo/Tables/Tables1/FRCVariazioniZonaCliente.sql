CREATE TABLE [dbo].[FRCVariazioniZonaCliente] (
    ...
    PRIMARY KEY CLUSTERED ([Ambiente] ASC, [Anno] ASC, [MeseInizio] ASC, [MeseFine] ASC, [Zona] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[FRCVariazioniZonaCliente] TO [Metodo98]
    AS [dbo];

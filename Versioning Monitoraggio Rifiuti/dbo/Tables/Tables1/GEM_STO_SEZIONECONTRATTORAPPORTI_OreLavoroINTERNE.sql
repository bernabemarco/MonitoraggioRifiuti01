CREATE TABLE [dbo].[GEM_STO_SEZIONECONTRATTORAPPORTI_OreLavoroINTERNE] (
    ...
    CONSTRAINT [PK_GEM_STO_SEZIONECONTRATTORAPPORTI_OreLavoroINTERNE] PRIMARY KEY CLUSTERED ([IDRAPPORTO] ASC, [idRiga] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[GEM_STO_SEZIONECONTRATTORAPPORTI_OreLavoroINTERNE] TO [Metodo98]
    AS [dbo];

CREATE TABLE [dbo].[GRI_RAPPORTI_Materiali] (
    ...
    CONSTRAINT [GRI_RAPPORTI_Materiali_PK] PRIMARY KEY CLUSTERED ([IDRAPPORTO] ASC, [IDRIGA] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[GRI_RAPPORTI_Materiali] TO [Metodo98]
    AS [dbo];

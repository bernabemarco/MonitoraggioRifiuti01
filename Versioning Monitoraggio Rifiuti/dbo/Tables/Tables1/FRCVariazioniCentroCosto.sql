CREATE TABLE [dbo].[FRCVariazioniCentroCosto] (
    ...
    PRIMARY KEY CLUSTERED ([Ambiente] ASC, [Anno] ASC, [MeseInizio] ASC, [MeseFine] ASC, [Centro] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[FRCVariazioniCentroCosto] TO [Metodo98]
    AS [dbo];

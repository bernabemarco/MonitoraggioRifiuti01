CREATE TABLE [dbo].[GEM_SEZIONECONTRATTORAPPORTIMEZZI] (
    ...
    [QUANTITA]             NUMERIC (5)     CONSTRAINT [DF_GEM_SEZIONECONTRATTORAPPORTIMEZZI_QUANTITA] DEFAULT ((1)) NULL,
    [TEMPO_MAN]            DECIMAL (5, 2)  DEFAULT ((0)) NULL,
    [IMPORTOAT1]           DECIMAL (12, 4) CONSTRAINT [DF_GEM_SEZIONECONTRATTORAPPORTIMEZZI_IMPORTOAT1] DEFAULT ((0)) NULL,
    [IMPORTOAT2]           DECIMAL (12, 4) CONSTRAINT [DF_GEM_SEZIONECONTRATTORAPPORTIMEZZI_IMPORTOAT2] DEFAULT ((0)) NULL,
    [IMPORTOAT3]           DECIMAL (12, 4) CONSTRAINT [DF_GEM_SEZIONECONTRATTORAPPORTIMEZZI_IMPORTOAT3] DEFAULT ((0)) NULL,
    [IMPORTOAT4]           DECIMAL (12, 4) CONSTRAINT [DF_GEM_SEZIONECONTRATTORAPPORTIMEZZI_IMPORTOAT4] DEFAULT ((0)) NULL,
    [IMPORTOAT5]           DECIMAL (12, 4) CONSTRAINT [DF_GEM_SEZIONECONTRATTORAPPORTIMEZZI_IMPORTOAT5] DEFAULT ((0)) NULL,
    ...
    CONSTRAINT [GEM_SEZIONECONTRATTORAPPORTIMEZZI_PK] PRIMARY KEY CLUSTERED ([IDCONTRATTO] ASC, [SEZIONECONTRATTO] ASC, [IDRAPPORTO] ASC, [IdRigaMezzo] ASC)
);


GO
CREATE NONCLUSTERED INDEX [GEM_SEZIONECONTRATTORAPPORTIMEZZI_IdRapporto]
    ON [dbo].[GEM_SEZIONECONTRATTORAPPORTIMEZZI]([IDRAPPORTO] ASC);


GO
CREATE NONCLUSTERED INDEX [GEM_SEZIONECONTRATTORAPPORTIMEZZI_IdRigaMezzo]
    ON [dbo].[GEM_SEZIONECONTRATTORAPPORTIMEZZI]([IdRigaMezzo] ASC);


GO
CREATE NONCLUSTERED INDEX [GEM_SEZIONECONTRATTORAPPORTIMEZZI_NOTE]
    ON [dbo].[GEM_SEZIONECONTRATTORAPPORTIMEZZI]([NOTE] ASC);


GO
CREATE NONCLUSTERED INDEX [GEM_SEZIONECONTRATTORAPPORTIMEZZI_CodiceMezzoChekList+VersioneChekList]
    ON [dbo].[GEM_SEZIONECONTRATTORAPPORTIMEZZI]([CodiceMezzoChekList] ASC, [VersioneChekList] ASC);


GO


/*  DELETE TRIGGER "ALD_GEM_SEZIONECONTRATTORAPPORTIMEZZI_TD" FOR TABLE "GEM_SEZIONECONTRATTORAPPORTIMEZZI"  */

CREATE TRIGGER [dbo].[ALD_GEM_SEZIONECONTRATTORAPPORTIMEZZI_TD] ON [dbo].[GEM_SEZIONECONTRATTORAPPORTIMEZZI] FOR DELETE AS
...
BEGIN
    ...
    /*  DELETE ALL CHILDREN IN "GEM_SEZIONECONTRATTORAPPORTIMEZZI_CheckList"  */
    DELETE GEM_SEZIONECONTRATTORAPPORTIMEZZI_CheckList
    FROM   GEM_SEZIONECONTRATTORAPPORTIMEZZI_CheckList T2, DELETED T1
    WHERE  T2.IDRAPPORTO = T1.IDRAPPORTO and T2.IdRigaMezzo = T1.IdRigaMezzo
...
/****** Oggetto:  Trigger [ALD_TestaSezioniContrattoCPagamento]    Data script: 05/30/2013 17:26:53 ******/
SET ANSI_NULLS ON

GO
GRANT DELETE
    ON OBJECT::[dbo].[GEM_SEZIONECONTRATTORAPPORTIMEZZI] TO [Metodo98]
    AS [dbo];

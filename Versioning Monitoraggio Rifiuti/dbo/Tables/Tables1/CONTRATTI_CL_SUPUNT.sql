CREATE TABLE [dbo].[CONTRATTI_CL_SUPUNT] (
    ...
    [GGTOLLERANZA]            SMALLINT      DEFAULT ((0)) NULL,
...
CREATE TRIGGER  TD_CONTRATTI_CL_SUPUNT ON CONTRATTI_CL_SUPUNT
FOR DELETE 
AS
...
GO
GRANT DELETE
    ON OBJECT::[dbo].[CONTRATTI_CL_SUPUNT] TO [Metodo98]
    AS [dbo];

CREATE TABLE [dbo].[BudBudgetModelloVariante3] (
    ...
    PRIMARY KEY CLUSTERED ([Stagione] ASC, [AnnoStagione] ASC, [TipologiaProdotto] ASC, [Ambiente] ASC, [TipoCliente] ASC, [Famiglia] ASC, [TipoBudget] ASC, [ModelloBudget] ASC, [Modello] ASC, [Variante1] ASC, [Variante2] ASC, [Variante3] ASC) WITH (FILLFACTOR = 90)
);


GO

/*  DELETE TRIGGER "TD_BudBudgetModelloVariante3" FOR TABLE "BudBudgetModelloVariante3"  */
CREATE TRIGGER TD_BudBudgetModelloVariante3 ON BudBudgetModelloVariante3 FOR DELETE AS
BEGIN
    DECLARE
       @NUMROWS  INT,
       @ERRNO    INT,
    ...
    /*  DELETE ALL CHILDREN IN "BudBudgetModelloVariante4"  */
    DELETE BudBudgetModelloVariante4
    FROM   BudBudgetModelloVariante4 T2, DELETED T1
    WHERE  T2.Stagione = T1.Stagione AND T2.AnnoStagione = T1.AnnoStagione AND 
           ...
           T2.Variante2 = T1.Variante2 AND T2.Variante3 = T1.Variante3
...
GO
GRANT DELETE
    ON OBJECT::[dbo].[BudBudgetModelloVariante3] TO [Metodo98]
    AS [dbo];

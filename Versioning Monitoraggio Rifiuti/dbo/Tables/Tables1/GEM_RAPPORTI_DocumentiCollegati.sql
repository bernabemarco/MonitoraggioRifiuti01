CREATE TABLE [dbo].[GEM_RAPPORTI_DocumentiCollegati] (
    ...
    CONSTRAINT [GEM_RAPPORTI_DocumentiCollegati_PK] PRIMARY KEY CLUSTERED ([IDRapporto] ASC, [IDRIGA] ASC, [IDCONTRATTO] ASC, [SEZIONECONTRATTO] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[GEM_RAPPORTI_DocumentiCollegati] TO [Metodo98]
    AS [dbo];

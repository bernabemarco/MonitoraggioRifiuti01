CREATE TABLE [dbo].[GEM_SEZIONECONTRATTORAPPORTIMEZZI_Allegati] (
    ...
    CONSTRAINT [GEM_SEZIONECONTRATTORAPPORTIMEZZI_Allegati_PK] PRIMARY KEY CLUSTERED ([IDCONTRATTO] ASC, [SEZIONECONTRATTO] ASC, [IDRapporto] ASC, [IdRigaMezzo] ASC, [IDRIGAAllegato] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[GEM_SEZIONECONTRATTORAPPORTIMEZZI_Allegati] TO [Metodo98]
    AS [dbo];

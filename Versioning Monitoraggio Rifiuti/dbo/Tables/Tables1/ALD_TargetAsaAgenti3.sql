CREATE TABLE [dbo].[ALD_TargetAsaAgenti3] (
    ...
    CONSTRAINT [PK_ALD_TargetAsaAgenti3] PRIMARY KEY CLUSTERED ([Ditta] ASC, [CodAgente3] ASC, [AnnoTarget] ASC, [MeseTarget] ASC, [IdAsa] ASC, [idOrFatt] ASC) WITH (FILLFACTOR = 90)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[ALD_TargetAsaAgenti3] TO [Metodo98]
    AS [dbo];

CREATE TABLE [dbo].[ALD_TEMPCONFORMITA] (
    ...
    CONSTRAINT [PK_ALD_TEMPCONFORMITA] PRIMARY KEY CLUSTERED ([IDSESSIONE] ASC, [POSIZIONE] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[ALD_TEMPCONFORMITA] TO [Metodo98]
    AS [dbo];

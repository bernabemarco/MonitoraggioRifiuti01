CREATE TABLE [dbo].[GEM_SEZIONECONTRATTORAPPORTI_Materiali] (
    ...
    CONSTRAINT [GEM_SEZIONECONTRATTORAPPORTI_Materiali_PK] PRIMARY KEY CLUSTERED ([IDRAPPORTO] ASC, [IDRIGA] ASC)
);


GO
CREATE NONCLUSTERED INDEX [GEM_SEZIONECONTRATTORAPPORTI_Materiali_IdMateriali]
    ON [dbo].[GEM_SEZIONECONTRATTORAPPORTI_Materiali]([IDMATERIALE] ASC);


GO
GRANT DELETE
    ON OBJECT::[dbo].[GEM_SEZIONECONTRATTORAPPORTI_Materiali] TO [Metodo98]
    AS [dbo];

CREATE TABLE [dbo].[FRCScostamentiMateriali] (
    ...
    CONSTRAINT [KEY_FRCScostamentiMateriali] PRIMARY KEY CLUSTERED ([ID] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[FRCScostamentiMateriali] TO [Metodo98]
    AS [dbo];

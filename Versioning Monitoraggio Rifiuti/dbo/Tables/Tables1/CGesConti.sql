...
GO
CREATE UNIQUE NONCLUSTERED INDEX [CGesConti_CodDes]
    ON [dbo].[CGesConti]([CodConto] ASC) WITH (FILLFACTOR = 90);


GO
GRANT DELETE
    ON OBJECT::[dbo].[CGesConti] TO [Metodo98]
    AS [dbo];

CREATE TABLE [dbo].[GEM_STO_SEZIONECONTRATTORAPPORTI_OreLavoro] (
    ...
    CONSTRAINT [PK_GEM_STO_SEZIONECONTRATTORAPPORTI_OreLavoro] PRIMARY KEY CLUSTERED ([IDRAPPORTO] ASC, [idRiga] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[GEM_STO_SEZIONECONTRATTORAPPORTI_OreLavoro] TO [Metodo98]
    AS [dbo];

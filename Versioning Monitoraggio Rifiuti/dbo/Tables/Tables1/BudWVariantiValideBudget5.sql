CREATE TABLE [dbo].[BudWVariantiValideBudget5] (
    ...
    [Tipologia5]  VARCHAR (3)  NOT NULL,
    [Variante5]   VARCHAR (8)  NOT NULL
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[BudWVariantiValideBudget5] TO [Metodo98]
    AS [dbo];

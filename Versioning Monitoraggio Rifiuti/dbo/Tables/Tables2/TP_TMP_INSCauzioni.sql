CREATE TABLE [dbo].[TP_TMP_INSCauzioni] (
    [IDSessione]          DECIMAL (5)     NOT NULL,
    [ProgMissDoc]         DECIMAL (10)    NOT NULL,
    ...
    CONSTRAINT [PK_TP_TMP_INSCauzioni] PRIMARY KEY CLUSTERED ([IDSessione] ASC, [ProgMissDoc] ASC, [IDTesta] ASC, [IDRiga] ASC) WITH (FILLFACTOR = 90)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[TP_TMP_INSCauzioni] TO [Metodo98]
    AS [dbo];

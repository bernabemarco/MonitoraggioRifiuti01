CREATE TABLE [dbo].[TEMPSTPQUADROFNELENCHICF] (
    ...
    CONSTRAINT [PK_TEMPSTPQUADROFNELENCHICF] PRIMARY KEY CLUSTERED ([IDSESSIONE] ASC, [NRPAGINA] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[TEMPSTPQUADROFNELENCHICF] TO [Metodo98]
    AS [dbo];

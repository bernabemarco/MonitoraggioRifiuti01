CREATE TABLE [dbo].[PROMOZIONI_ELENCOARTICOLI] (
    ...
    [PRIORITA]         SMALLINT         CONSTRAINT [DF_PROMOZIONI_ELENCOARTICOLI_PRIORITA] DEFAULT ((0)) NULL,
...
GO
GRANT DELETE
    ON OBJECT::[dbo].[PROMOZIONI_ELENCOARTICOLI] TO [Metodo98]
    AS [dbo];

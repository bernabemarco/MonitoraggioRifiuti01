CREATE TABLE [dbo].[TMPTabRigheMiss_2] (
    ...
    CONSTRAINT [PK_TMPTabRigheMiss_2] PRIMARY KEY CLUSTERED ([IDSESSIONE] ASC, [RIFPROGRESSIVO] ASC, [RIFIDRIGARIGHEMISS_1] ASC, [IDRIGA] ASC) WITH (FILLFACTOR = 90)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[TMPTabRigheMiss_2] TO [Metodo98]
    AS [dbo];

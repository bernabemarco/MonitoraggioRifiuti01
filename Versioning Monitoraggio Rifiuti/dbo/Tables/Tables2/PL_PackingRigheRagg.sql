CREATE TABLE [dbo].[PL_PackingRigheRagg] (
    ...
    [TIPO]              SMALLINT        NULL,
    [PESOLETTO]         DECIMAL (16, 6) CONSTRAINT [DF_PL_PACKINGRIGHERAGG_PESOLETTO] DEFAULT ((0)) NULL,
...
GO
GRANT DELETE
    ON OBJECT::[dbo].[PL_PackingRigheRagg] TO [Metodo98]
    AS [dbo];

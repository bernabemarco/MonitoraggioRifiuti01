CREATE TABLE [dbo].[MYTHO_ProductEntities] (
    [ProductEntityId]                     BIGINT          NOT NULL,
    [ItemSKU]                             NVARCHAR (20)   NOT NULL,
    [ActionCode]                          INT             NULL,
    [CreationDate]                        DATETIME        NULL,
    [StatusCode]                          INT             NULL,
    [ExecutedDate]                        DATETIME        NULL,
    [ErrorDetails]                        NVARCHAR (MAX)  NULL,
    [ProductOxID]                         INT             NULL,
    ...
    CONSTRAINT [PK_MYTHO_ProductEntities] PRIMARY KEY CLUSTERED ([ProductEntityId] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[MYTHO_ProductEntities] TO [Metodo98]
    AS [dbo];

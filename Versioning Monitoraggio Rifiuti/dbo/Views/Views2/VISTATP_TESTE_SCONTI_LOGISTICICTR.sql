...
CREATE VIEW VISTATP_TESTE_SCONTI_LOGISTICICTR
AS
...
FROM         TP_TESTE_SCONTI_LOGISTICICTR LEFT OUTER JOIN
                      ANAGRAFICACF ON CODCLIFOR = ANAGRAFICACF.CODCONTO


GO
GRANT SELECT
    ON OBJECT::[dbo].[VISTATP_TESTE_SCONTI_LOGISTICICTR] TO [Metodo98]
    AS [dbo];

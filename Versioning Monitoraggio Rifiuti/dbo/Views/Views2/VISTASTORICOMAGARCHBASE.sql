CREATE VIEW VISTASTORICOMAGARCHBASE AS
SELECT STMAG.BIS,
        STMAG.CODART,
...
FROM STORICOMAGARCH STMAG,TABCAUSALIMAG CAUMAG,ANAGRAFICADEPOSITI,ANAGRAFICACF AC,ANAGRAFICARISERVATICF ACR,ANAGRAFICAARTICOLI AA, TABUTENTI
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[VISTASTORICOMAGARCHBASE] TO [Metodo98]
    AS [dbo];

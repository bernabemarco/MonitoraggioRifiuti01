CREATE VIEW VISTAPARTITARIPN3 AS
SELECT
 	TC.PROGRESSIVO,
	TC.ESERCIZIO,
	TC.DATAREG,
	...
	(SELECT SUM(SALDO) FROM VISTABILANCI3 WHERE CODCONTO=RC.CONTO AND ESERCIZIO=(SELECT ESERCIZIOATTIVO FROM TABUTENTI WHERE USERDB=CAST(USER_NAME() AS VARCHAR(25))) AND PROGRESSIVO=0 AND NRGIORNALE=TC.NRGIORNALE) AS SALDOINIZ,
	(SELECT SUM(SALDOEURO) FROM VISTABILANCI3 WHERE CODCONTO=RC.CONTO AND ESERCIZIO=(SELECT ESERCIZIOATTIVO FROM TABUTENTI WHERE USERDB=CAST(USER_NAME() AS VARCHAR(25))) AND PROGRESSIVO=0 AND NRGIORNALE=TC.NRGIORNALE) AS SALDOINIZEURO,
	(SELECT SUM(SALDOVALUTA) FROM VISTABILANCI3 WHERE CODCONTO=RC.CONTO AND ESERCIZIO=(SELECT ESERCIZIOATTIVO FROM TABUTENTI WHERE USERDB=CAST(USER_NAME() AS VARCHAR(25))) AND PROGRESSIVO=0 AND NRGIORNALE=TC.NRGIORNALE) AS SALDOINIZVALUTA,
...
SELECT 
	...
	(SELECT SUM(SALDO) FROM VISTABILANCI3 WHERE CODCONTO=RCONT.CONTO AND ESERCIZIO=(SELECT ESERCIZIOATTIVO FROM TABUTENTI WHERE USERDB=CAST(USER_NAME() AS VARCHAR(25))) AND PROGRESSIVO=0 AND NRGIORNALE=TCONT.NRGIORNALE) AS SALDOINIZ,
	(SELECT SUM(SALDOEURO) FROM VISTABILANCI3 WHERE CODCONTO=RCONT.CONTO AND ESERCIZIO=(SELECT ESERCIZIOATTIVO FROM TABUTENTI WHERE USERDB=CAST(USER_NAME() AS VARCHAR(25))) AND PROGRESSIVO=0 AND NRGIORNALE=TCONT.NRGIORNALE) AS SALDOINIZEURO,
	(SELECT SUM(SALDOVALUTA) FROM VISTABILANCI3 WHERE CODCONTO=RCONT.CONTO AND ESERCIZIO=(SELECT ESERCIZIOATTIVO FROM TABUTENTI WHERE USERDB=CAST(USER_NAME() AS VARCHAR(25))) AND PROGRESSIVO=0 AND NRGIORNALE=TCONT.NRGIORNALE) AS SALDOINIZVALUTA,
	1 AS ACCESSOUTENTE
    FROM 
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[VISTAPARTITARIPN3] TO [Metodo98]
    AS [dbo];

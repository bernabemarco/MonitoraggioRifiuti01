CREATE VIEW VISTAUNIONSCADENZE1 AS
SELECT TIPOREC=1,SC.PROGRESSIVO,
  ...
  (SELECT SUM(ISNULL(Saldo,0))+SUM(ISNULL(Dare,0))-SUM(ISNULL(Avere,0)) FROM VistaBilanci1 WHERE CodConto=(SELECT CODCONTORIF FROM ANAGRAFICABANCHE WHERE CODBANCA=SC.BANCAINC) AND Esercizio=(SELECT EsercizioAttivo FROM TabUtenti WHERE USERDB=CAST(USER_NAME() AS VARCHAR(25))) AND (Causale<>(SELECT CausContCH FROM TabVincoliGIC WHERE Esercizio=(SELECT EsercizioAttivo FROM TabUtenti WHERE USERDB=CAST(USER_NAME() AS VARCHAR(25)))) OR Causale IS NULL)) AS SALDOBANCA,
  (SELECT SUM(ISNULL(SaldoValuta,0))+SUM(ISNULL(DareValuta,0))-SUM(ISNULL(AvereValuta,0)) FROM VistaBilanci1 WHERE CodConto=(SELECT CODCONTORIF FROM ANAGRAFICABANCHE WHERE CODBANCA=SC.BANCAINC) AND Esercizio=(SELECT EsercizioAttivo FROM TabUtenti WHERE USERDB=CAST(USER_NAME() AS VARCHAR(25))) AND (Causale<>(SELECT CausContCH FROM TabVincoliGIC WHERE Esercizio=(SELECT EsercizioAttivo FROM TabUtenti WHERE USERDB=CAST(USER_NAME() AS VARCHAR(25)))) OR Causale IS NULL)) AS SALDOBANCAVALUTA,
  (SELECT SUM(ISNULL(SaldoEuro,0))+SUM(ISNULL(DareEuro,0))-SUM(ISNULL(AvereEuro,0)) FROM VistaBilanci1 WHERE CodConto=(SELECT CODCONTORIF FROM ANAGRAFICABANCHE WHERE CODBANCA=SC.BANCAINC) AND Esercizio=(SELECT EsercizioAttivo FROM TabUtenti WHERE USERDB=CAST(USER_NAME() AS VARCHAR(25))) AND (Causale<>(SELECT CausContCH FROM TabVincoliGIC WHERE Esercizio=(SELECT EsercizioAttivo FROM TabUtenti WHERE USERDB=CAST(USER_NAME() AS VARCHAR(25)))) OR Causale IS NULL)) AS SALDOBANCAEURO
  FROM TABSCADENZE SC
UNION ALL
  ...
  (SELECT SUM(ISNULL(Saldo,0))+SUM(ISNULL(Dare,0))-SUM(ISNULL(Avere,0)) FROM VistaBilanci1 WHERE CodConto=(SELECT CODCONTORIF FROM ANAGRAFICABANCHE WHERE CODBANCA=SP.BANCAINC) AND Esercizio=(SELECT EsercizioAttivo FROM TabUtenti WHERE USERDB=CAST(USER_NAME() AS VARCHAR(25))) AND (Causale<>(SELECT CausContCH FROM TabVincoliGIC WHERE Esercizio=(SELECT EsercizioAttivo FROM TabUtenti WHERE USERDB=CAST(USER_NAME() AS VARCHAR(25)))) OR Causale IS NULL)) AS SALDOBANCA,
  (SELECT SUM(ISNULL(SaldoValuta,0))+SUM(ISNULL(DareValuta,0))-SUM(ISNULL(AvereValuta,0)) FROM VistaBilanci1 WHERE CodConto=(SELECT CODCONTORIF FROM ANAGRAFICABANCHE WHERE CODBANCA=SP.BANCAINC) AND Esercizio=(SELECT EsercizioAttivo FROM TabUtenti WHERE USERDB=CAST(USER_NAME() AS VARCHAR(25))) AND (Causale<>(SELECT CausContCH FROM TabVincoliGIC WHERE Esercizio=(SELECT EsercizioAttivo FROM TabUtenti WHERE USERDB=CAST(USER_NAME() AS VARCHAR(25)))) OR Causale IS NULL)) AS SALDOBANCAVALUTA,
  (SELECT SUM(ISNULL(SaldoEuro,0))+SUM(ISNULL(DareEuro,0))-SUM(ISNULL(AvereEuro,0)) FROM VistaBilanci1 WHERE CodConto=(SELECT CODCONTORIF FROM ANAGRAFICABANCHE WHERE CODBANCA=SP.BANCAINC) AND Esercizio=(SELECT EsercizioAttivo FROM TabUtenti WHERE USERDB=CAST(USER_NAME() AS VARCHAR(25))) AND (Causale<>(SELECT CausContCH FROM TabVincoliGIC WHERE Esercizio=(SELECT EsercizioAttivo FROM TabUtenti WHERE USERDB=CAST(USER_NAME() AS VARCHAR(25)))) OR Causale IS NULL)) AS SALDOBANCAEURO
  FROM SCADENZEPREVISIONALI SP


GO
GRANT SELECT
    ON OBJECT::[dbo].[VISTAUNIONSCADENZE1] TO [Metodo98]
    AS [dbo];

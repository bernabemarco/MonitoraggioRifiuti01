...
/****** Oggetto:  View [dbo].[GEM_VistaComponenti_Visione]    Data script: 08/30/2010 14:03:52 ******/

CREATE VIEW [dbo].[GEM_VistaComponenti_Visione]
AS
SELECT     t.IDCONTRATTO, t.CODCLIENTE, t.CODCLIFAT, t.DATACONTRATTO, t.DATAEFFICACIA, t.DATAPVISITA, t.DURATA, t.FLAG_PROV, t.PAGAMENTO, 
                      ...
                      SComp.IMPORTO_UNITARIO, SComp.ELIMINATO, SComp.SEGNALATO, SComp.NOTE
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[GEM_VistaComponenti_Visione] TO [Metodo98]
    AS [dbo];

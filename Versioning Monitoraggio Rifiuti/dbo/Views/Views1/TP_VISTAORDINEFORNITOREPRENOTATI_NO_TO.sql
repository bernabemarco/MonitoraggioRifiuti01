...
CREATE VIEW [dbo].[TP_VISTAORDINEFORNITOREPRENOTATI_NO_TO]
AS
...
SELECT
    ...
    Tp_DocumentiPrelevati.QtaORD,
    Tp_DocumentiPrelevati.QtaPRP
FROM RIGHEDOCUMENTI 
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[TP_VISTAORDINEFORNITOREPRENOTATI_NO_TO] TO [Metodo98]
    AS [dbo];

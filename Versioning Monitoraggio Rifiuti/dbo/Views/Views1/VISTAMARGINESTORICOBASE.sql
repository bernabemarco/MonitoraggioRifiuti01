CREATE VIEW VISTAMARGINESTORICOBASE AS
SELECT STMAG.BIS,
        STMAG.CODART,
...
FROM STORICOMAG STMAG,TABCAUSALIMAG CAUMAG,VISTACLIFOR,ANAGRAFICAARTICOLI AA
WHERE (STMAG.CODCAUSALE=CAUMAG.CODICE) AND (STMAG.CODCLIFOR=VISTACLIFOR.CODCONTO)
        AND (STMAG.CODART=AA.CODICE)

GO
GRANT SELECT
    ON OBJECT::[dbo].[VISTAMARGINESTORICOBASE] TO [Metodo98]
    AS [dbo];

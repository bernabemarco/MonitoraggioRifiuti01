CREATE VIEW VISTAMARGINESTORICOBASESTAT AS
SELECT STMAG.BIS,
        STMAG.CODART,
...
FROM STORICOMAG STMAG,TABCAUSALIMAG CAUMAG,VISTACLIFOR,ANAGRAFICAARTICOLI AA, TABUTENTI
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[VISTAMARGINESTORICOBASESTAT] TO [Metodo98]
    AS [dbo];

...
CREATE VIEW FRCVistaArticoli AS 
	SELECT ANAGRAFICAARTICOLI.CODICE AS CODART, ANAGRAFICAARTICOLI.DESCRIZIONE, RIGHT(ANAGRAFICAARTICOLI.CODICE, 50) 
		   ...
		   ARTICOLIFATTORICONVERSIONE.FATTORE, ARTICOLIUMPREFERITE_1.TIPOUM, ARTICOLIUMPREFERITE.TIPOUM AS TIPOUMBASE
	...
	GROUP BY ANAGRAFICAARTICOLI.CODICE, ANAGRAFICAARTICOLI.DESCRIZIONE, ISNULL(ANAGRAFICAARTICOLI.GRUPPO, 0), ISNULL(TABGRUPPI.DESCRIZIONE, ''), 
			 ...
			 ARTICOLIFATTORICONVERSIONE.UM2, ARTICOLIFATTORICONVERSIONE.FATTORE, ARTICOLIUMPREFERITE_1.TIPOUM, ARTICOLIUMPREFERITE.TIPOUM
	HAVING ARTICOLIUMPREFERITE_1.TIPOUM = 3 AND ARTICOLIUMPREFERITE.TIPOUM = 1

GO
GRANT SELECT
    ON OBJECT::[dbo].[FRCVistaArticoli] TO [Metodo98]
    AS [dbo];

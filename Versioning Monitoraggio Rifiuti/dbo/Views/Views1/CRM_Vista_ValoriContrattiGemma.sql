...
CREATE VIEW  [dbo].[CRM_Vista_ValoriContrattiGemma]
AS
...
and (isnull(SCM.ELIMINATO,0) IN ('', '0', 'N'))
...
FROM         CRM_Vista_CalcoloValoriContratti AS VC INNER JOIN
...
GO
GRANT DELETE
    ON OBJECT::[dbo].[CRM_Vista_ValoriContrattiGemma] TO [Metodo98]
    AS [dbo];

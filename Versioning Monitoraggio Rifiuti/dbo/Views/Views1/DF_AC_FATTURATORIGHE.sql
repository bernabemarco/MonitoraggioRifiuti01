...
CREATE VIEW DF_AC_FATTURATORIGHE
AS
...
SELECT T.[PROGRESSIVO]
  ...
  FROM [PARAMETRIDOC] P
  INNER JOIN [TESTEDOCUMENTI] T ON P.TIPO IN('F','N') AND P.CLIFOR = 'C' AND P.CODICE = T.TIPODOC 
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[DF_AC_FATTURATORIGHE] TO [Metodo98]
    AS [dbo];

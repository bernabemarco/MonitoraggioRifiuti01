...
CREATE VIEW [dbo].[GEM_VistaListiniContrattiRighe]
as
...
from  dbo.GEM_ListiniContratti lt inner join dbo.GEM_ListiniContrattoRighe lr on lt.idGListinoContr= lr.idGListinoContr
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[GEM_VistaListiniContrattiRighe] TO [Metodo98]
    AS [dbo];

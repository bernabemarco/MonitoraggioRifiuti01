...
CREATE VIEW VISTAGESTIONEPREZZI AS
        ...
        FROM GESTIONEPREZZI GP, GESTIONEPREZZIRIGHE GPR WHERE (GP.PROGRESSIVO=GPR.RIFPROGRESSIVO)


GO
GRANT SELECT
    ON OBJECT::[dbo].[VISTAGESTIONEPREZZI] TO [Metodo98]
    AS [dbo];

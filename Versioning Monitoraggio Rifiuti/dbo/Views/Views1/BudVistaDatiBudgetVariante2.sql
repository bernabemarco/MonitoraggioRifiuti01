CREATE VIEW BudVistaDatiBudgetVariante2 AS 
    SELECT Stagione, (SELECT Descrizione FROM BudTabStagione WHERE Codice = Stagione) AS DesStagione, 
           ...
           Modello, (SELECT Descrizione FROM AnagraficaArticoli WHERE Codice = BudBudgetModelloVariante2.Modello) AS DesModello, 
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[BudVistaDatiBudgetVariante2] TO [Metodo98]
    AS [dbo];

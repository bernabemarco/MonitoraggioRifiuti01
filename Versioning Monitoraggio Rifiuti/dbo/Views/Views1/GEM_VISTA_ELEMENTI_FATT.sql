CREATE VIEW [dbo].[GEM_VISTA_ELEMENTI_FATT] AS
	SELECT 
		EF.idcontratto,
		EF.SezioneContratto,
		EF.IdRapporto,
	...
	--where idrapporto = '2017OR046439SI'
	GROUP BY 
		EF.idcontratto,
		EF.SezioneContratto,
		EF.IdRapporto,
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[GEM_VISTA_ELEMENTI_FATT] TO [Metodo98]
    AS [dbo];

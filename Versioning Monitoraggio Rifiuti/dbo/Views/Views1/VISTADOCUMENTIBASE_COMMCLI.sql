CREATE VIEW VISTADOCUMENTIBASE_COMMCLI AS
    ...
    RD.CAUSALEMAG, RD.CAUSALEMAGCOLL, RD.CAUSALEMAGCOMP, RD.CAUSALEMAGCOMPCOLL,
    RD.NRPEZZIIMBALLO, RD.CODIMBALLO, RD.NOMENCLCOMBINATA,
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[VISTADOCUMENTIBASE_COMMCLI] TO [Metodo98]
    AS [dbo];

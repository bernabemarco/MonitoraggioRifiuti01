...
CREATE VIEW [dbo].[CONTRATTILIQUIDAZIONE_CLPERC]
AS
SELECT     TOP (100) PERCENT 'INCONDIZIONATI-COND' AS TIPOCONTRIBUTO, dbo.CONTRATTI_CL.RIFPROGRESSIVO AS RifContratto, 
                      dbo.CONTRATTI_CL.NRRIGA AS RifContributo, 0 AS RIFSOTTORIGA, 0 AS RIFSOTTORIGACOND, dbo.CONTRATTI_CL.DESCRIZIONE AS NOTA, 
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[CONTRATTILIQUIDAZIONE_CLPERC] TO [Metodo98]
    AS [dbo];

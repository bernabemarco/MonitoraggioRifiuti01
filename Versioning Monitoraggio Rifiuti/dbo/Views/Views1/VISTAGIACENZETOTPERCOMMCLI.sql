create view VISTAGIACENZETOTPERCOMMCLI
...
FROM 
	STORICOMAG STMAG
GROUP BY 
	CODART,ESERCIZIO,NRIFPARTITA,CODDEPOSITO,CODUBICAZIONE,CODCOMMESSA

GO
GRANT SELECT
    ON OBJECT::[dbo].[VISTAGIACENZETOTPERCOMMCLI] TO [Metodo98]
    AS [dbo];

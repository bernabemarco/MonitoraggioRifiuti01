...
create view [dbo].[CRM_VISTA_ANAGRAFICAAGENTI3]
as 
SELECT      (SELECT     TOP (1) IdSocieta
                       FROM          ALD_TabDittaDatiAggiuntivi) + ANAGRAFICAAGENTI.CODAGENTE AS CODAGENTE3, ANAGRAFICAAGENTI.DSCAGENTE, ANAGRAFICAAGENTI.INDIRIZZO, 
...
GO
GRANT DELETE
    ON OBJECT::[dbo].[CRM_VISTA_ANAGRAFICAAGENTI3] TO [Metodo98]
    AS [dbo];

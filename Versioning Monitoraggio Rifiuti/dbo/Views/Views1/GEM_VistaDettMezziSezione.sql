...
CREATE VIEW [dbo].[GEM_VistaDettMezziSezione]
AS
SELECT     t.IDCONTRATTO, t.CODCLIENTE, t.CODCLIFAT, t.DATACONTRATTO, t.DATAEFFICACIA, t.DATAPVISITA, t.DURATA, t.FLAG_PROV, t.PAGAMENTO, t.NOTE, t.REFERENTE, 
                      ...
                      dm.StatoFuoriSede, dm.AnnotazioniTecnica
					  , dm.idRapportoUltimVista, dm.DataUltimaVisita, dm.RifLinkImmagine, dm.CodiceEdificio, dm.CodiceLivello, dm.CodiceVano, dm.PosizioneMappa, dm.CodBarCoord, dm.TipologiaBarre
FROM         dbo.GEM_TESTACONTRATTO AS t INNER JOIN
                      ...
                      dbo.GEM_SEZIONICONTRATTODETTMEZZI AS dm ON t.IDCONTRATTO = dm.IDCONTRATTO AND sc.IDCONTRATTO = dm.IDCONTRATTO AND 
                      sc.SEZIONECONTRATTO = dm.SEZIONECONTRATTO LEFT OUTER JOIN
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[GEM_VistaDettMezziSezione] TO [Metodo98]
    AS [dbo];

...
SELECT 
  ...
  WHERE (TCONT.CAUSALE=(SELECT TOP 1 GIC.CAUSCONTAP FROM TABVINCOLIGIC AS GIC WHERE GIC.ESERCIZIO=RCONT.ESERCIZIO) OR TCONT.CAUSALE IS NULL)


GO
GRANT SELECT
    ON OBJECT::[dbo].[VISTABILANCI1] TO [Metodo98]
    AS [dbo];

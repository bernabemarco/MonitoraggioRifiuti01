...
-- Description: 
-- =============================================
CREATE FUNCTION dbo.FunCostoMedioaData 
(
                ...
                IF @NoMovValore = 1
                    BEGIN
                        ...
                        WHERE Esercizio = @Esercizio
                              AND @Codart = Codart AND DataMov = @AllaData And ValoreCaricoEuro >=0
                         GROUP BY CodArt
                    END
                ELSE
                    BEGIN
                        ...
                        FROM VistaGiacenze 
                        WHERE Esercizio = @Esercizio
                              AND @Codart = Codart AND DataMov = @AllaData
                         GROUP BY CodArt
                    END 
            END
        ELSE
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[FunCostoMedioaData] TO [Metodo98]
    AS [dbo];

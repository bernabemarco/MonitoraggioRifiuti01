...
CREATE PROCEDURE [dbo].[CONTRATTI_VERCONDIZIONATON]
...
BEGIN
    ...
    Select tipodoc From contrattidoc_nccimp Where rifprogressivo=@RIFPROGRESSIVO
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[CONTRATTI_VERCONDIZIONATON] TO [Metodo98]
    AS [dbo];

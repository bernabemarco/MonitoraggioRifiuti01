...
CREATE PROCEDURE [dbo].[GEM_METSIC_TO_INT_SEZIONECONTRATTORAPPORTI_OreLavoroINTERNE] (@IDRAPPORTO as varchar(14),@TIPOOPERAZIONE as char(1),@Progressivo as decimal(10,0),@Stato as varchar(1)) AS
BEGIN
	...
	BEGIN
		...
		UPDATE INS 
		  ...
		  ,INS.[AZRIF] = @IdAzienda
			FROM GemmaSync.dbo.GEM_SEZIONECONTRATTORAPPORTI_OreLavoroINTERNE INS
			INNER JOIN GEM_SEZIONECONTRATTORAPPORTI_OreLavoroINTERNE MET ON
	...
	ELSE
	BEGIN
		INSERT INTO GemmaSync.dbo.GEM_SEZIONECONTRATTORAPPORTI_OreLavoroINTERNE
		(
		[PROGRESSIVO]
		,[IDRAPPORTO]
		,[IDRIGA]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GEM_METSIC_TO_INT_SEZIONECONTRATTORAPPORTI_OreLavoroINTERNE] TO [Metodo98]
    AS [dbo];

CREATE TABLE [dbo].[CONS_ALD_FI_AA_Fornitori_Ritorno] (
    [Esito]          VARCHAR (10)   NULL,
    [IdSocieta]      VARCHAR (4)    NOT NULL,
    [CodConto]       VARCHAR (7)    NOT NULL,
    [NumDDV]         DECIMAL (5)    DEFAULT ((0)) NULL,
    ...
    CONSTRAINT [PK_CONS_ALD_FI_AA_Fornitori_Ritorno] PRIMARY KEY CLUSTERED ([IdSocieta] ASC, [CodConto] ASC, [DataModifica] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[CONS_ALD_FI_AA_Fornitori_Ritorno] TO [Metodo98]
    AS [dbo];

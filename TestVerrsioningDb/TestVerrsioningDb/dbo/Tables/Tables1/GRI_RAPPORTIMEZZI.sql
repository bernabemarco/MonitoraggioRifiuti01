CREATE TABLE [dbo].[GRI_RAPPORTIMEZZI] (
    ...
    CONSTRAINT [GRI_RAPPORTIMEZZI_PK] PRIMARY KEY CLUSTERED ([IDRAPPORTO] ASC, [IdRigaMezzo] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[GRI_RAPPORTIMEZZI] TO [Metodo98]
    AS [dbo];

CREATE TABLE [dbo].[FP_LISTA_ESITI_SEL_TMP] (
    ...
    CONSTRAINT [PK_FP_LISTA_ESITI_SEL_TMP] PRIMARY KEY CLUSTERED ([IDSESSIONE] ASC, [ProgressivoWS] ASC, [ProgressivoSDI] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[FP_LISTA_ESITI_SEL_TMP] TO [Metodo98]
    AS [dbo];

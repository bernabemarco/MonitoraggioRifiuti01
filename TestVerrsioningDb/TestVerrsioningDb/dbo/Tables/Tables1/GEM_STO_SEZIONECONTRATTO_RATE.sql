CREATE TABLE [dbo].[GEM_STO_SEZIONECONTRATTO_RATE] (
    ...
    CONSTRAINT [GEM_STO_SEZIONECONTRATTO_RATE_PK] PRIMARY KEY CLUSTERED ([IDCONTRATTO] ASC, [NUMERORATA] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[GEM_STO_SEZIONECONTRATTO_RATE] TO [Metodo98]
    AS [dbo];

CREATE TABLE [dbo].[GEM_SEZIONI_Componenti] (
    ...
    [ELIMINATO]           CHAR (1)        CONSTRAINT [DF__GEM_SEZIO__ELIMI__429B0397] DEFAULT ('0') NOT NULL,
    ...
    CONSTRAINT [GEM_SEZIONI_Componenti_PK] PRIMARY KEY CLUSTERED ([IDCONTRATTO] ASC, [SEZIONECONTRATTO] ASC, [IdRigaMezzo] ASC, [POSIZIONE] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[GEM_SEZIONI_Componenti] TO [Metodo98]
    AS [dbo];

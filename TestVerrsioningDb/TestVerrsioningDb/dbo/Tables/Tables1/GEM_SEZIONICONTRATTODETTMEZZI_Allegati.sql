CREATE TABLE [dbo].[GEM_SEZIONICONTRATTODETTMEZZI_Allegati] (
    ...
    CONSTRAINT [GEM_SEZIONICONTRATTODETTMEZZI_Allegati_PK] PRIMARY KEY CLUSTERED ([IDCONTRATTO] ASC, [SEZIONECONTRATTO] ASC, [IdRigaMezzo] ASC, [IDRIGAAllegato] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[GEM_SEZIONICONTRATTODETTMEZZI_Allegati] TO [Metodo98]
    AS [dbo];

CREATE TABLE [dbo].[FRCDatiMaterialiCopia] (
    ...
    CONSTRAINT [KEY_FRCDatiMaterialiCopia] PRIMARY KEY CLUSTERED ([ID] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[FRCDatiMaterialiCopia] TO [Metodo98]
    AS [dbo];

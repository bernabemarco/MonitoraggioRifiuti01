CREATE TABLE [dbo].[ALD_TargetAgenti2] (
    ...
    CONSTRAINT [PK_ALD_TargetAgenti2] PRIMARY KEY CLUSTERED ([Ditta] ASC, [CodAgente2] ASC, [AnnoTarget] ASC, [MeseTarget] ASC, [FamigliaId] ASC) WITH (FILLFACTOR = 90)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[ALD_TargetAgenti2] TO [Metodo98]
    AS [dbo];

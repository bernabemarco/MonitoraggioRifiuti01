CREATE TABLE [dbo].[CGesWConfrontoBilancioRicl] (
    ...
    PRIMARY KEY CLUSTERED ([NrTerminale] ASC, [Voce] ASC, [NumColonna] ASC, [CodDestinazione] ASC, [CodConto] ASC, [Anno] ASC, [Mese] ASC) WITH (FILLFACTOR = 90)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[CGesWConfrontoBilancioRicl] TO [Metodo98]
    AS [dbo];

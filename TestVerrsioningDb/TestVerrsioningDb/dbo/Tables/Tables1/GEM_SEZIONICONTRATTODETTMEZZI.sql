CREATE TABLE [dbo].[GEM_SEZIONICONTRATTODETTMEZZI] (
    ...
    CONSTRAINT [GEM_SEZIONICONTRATTODETTMEZZI_PK] PRIMARY KEY CLUSTERED ([IDCONTRATTO] ASC, [SEZIONECONTRATTO] ASC, [IdRigaMezzo] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[GEM_SEZIONICONTRATTODETTMEZZI] TO [Metodo98]
    AS [dbo];

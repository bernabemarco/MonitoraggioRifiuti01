CREATE TABLE [dbo].[MYTHO_Users_TMP] (
    [IdSessione]               DECIMAL (5)     NULL,
    [Enabled]                  SMALLINT        DEFAULT ((0)) NOT NULL,
    [Changed]                  SMALLINT        CONSTRAINT [DF_MYTHO_Users_TMP_Changed] DEFAULT ((0)) NOT NULL,
    [CODICEMETODO]             VARCHAR (7)     NOT NULL,
    [IdUser]                   BIGINT          NULL,
    ...
    [UTENTEMODIFICA]           VARCHAR (25)    DEFAULT (user_name()) NULL,
    [DATAMODIFICA]             DATETIME        DEFAULT (getdate()) NOT NULL,
    CONSTRAINT [MYTHO_Users_TMP_CODICEMETODO] PRIMARY KEY CLUSTERED ([CODICEMETODO] ASC)
);


GO
GRANT DELETE
    ON OBJECT::[dbo].[MYTHO_Users_TMP] TO [Metodo98]
    AS [dbo];

CREATE TABLE [dbo].[TP_STORICO_MEDIAMOBILE] (
    ...
    [MAD]            DECIMAL (18, 6) DEFAULT ((0)) NOT NULL,
    [UtenteModifica] VARCHAR (25)    NOT NULL,
    [DataModifica]   DATETIME        NOT NULL,
    [OSSERVAZIONE]   INT             DEFAULT ((0)) NOT NULL,
    PRIMARY KEY CLUSTERED ([CodArticolo] ASC, [CodDeposito] ASC, [Periodo] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IX_ORDINEFORNITORE_MEDIAMOBILE_1]
    ON [dbo].[TP_STORICO_MEDIAMOBILE]([MAD] ASC)
    INCLUDE([CodArticolo], [CodDeposito]);


GO
GRANT DELETE
    ON OBJECT::[dbo].[TP_STORICO_MEDIAMOBILE] TO [Metodo98]
    AS [dbo];

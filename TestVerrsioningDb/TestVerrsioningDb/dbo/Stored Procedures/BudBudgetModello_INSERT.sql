...
CREATE PROCEDURE BudBudgetModello_INSERT(@Stagione VarChar(3), @AnnoStagione VarChar(3), @TipologiaProdotto VarChar(5), @TipoCliente VarChar(5), @Ambiente Decimal(5), @Quantita Decimal(16,6), @Percentuale Decimal(16,6), @Valore Decimal(19,6), @PercentualeV Decimal(16,6), @PrezzoMedio Decimal(19,6), @Utente VarChar(25)) AS
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[BudBudgetModello_INSERT] TO [Metodo98]
    AS [dbo];

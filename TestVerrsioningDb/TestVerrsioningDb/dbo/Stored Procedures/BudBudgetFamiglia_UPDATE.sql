...
CREATE PROCEDURE BudBudgetFamiglia_UPDATE(@Stagione VarChar(3), @AnnoStagione VarChar(3), @TipologiaProdotto VarChar(5), @Ambiente Decimal(5)) AS
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[BudBudgetFamiglia_UPDATE] TO [Metodo98]
    AS [dbo];

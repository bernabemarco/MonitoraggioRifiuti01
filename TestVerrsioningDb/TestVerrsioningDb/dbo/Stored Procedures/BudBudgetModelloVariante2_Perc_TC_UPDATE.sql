...
CREATE PROCEDURE BudBudgetModelloVariante2_Perc_TC_UPDATE(@Stagione VarChar(3), @AnnoStagione VarChar(3), @TipologiaProdotto VarChar(5), @Ambiente Decimal(5), @TipoCliente VarChar(5)) AS
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[BudBudgetModelloVariante2_Perc_TC_UPDATE] TO [Metodo98]
    AS [dbo];

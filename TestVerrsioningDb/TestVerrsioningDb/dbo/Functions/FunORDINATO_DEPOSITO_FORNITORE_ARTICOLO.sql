...
CREATE FUNCTION [dbo].[FunORDINATO_DEPOSITO_FORNITORE_ARTICOLO](@ARTICOLO nVARCHAR(50),
																 @ESERCIZIO INT,
...
DECLARE @ORDINATO			AS NUMERIC(19,6)
	...
	SELECT 
		@ORDINATOATTUALE = ISNULL(SUM(ORDINATOATTUALE),0)
	FROM
	(
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[FunORDINATO_DEPOSITO_FORNITORE_ARTICOLO] TO [Metodo98]
    AS [dbo];

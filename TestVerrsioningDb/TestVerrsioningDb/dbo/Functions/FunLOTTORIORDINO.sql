...
/****** Oggetto: funzione definita dall'utente dbo.FunLOTTORIORDINO    Data dello script: 13/07/2005 15.24.44 ******/
CREATE FUNCTION [dbo].[FunLOTTORIORDINO](@ARTICOLO nVARCHAR(50),
										 @ESERCIZIO INT,
...
DECLARE @TMP_LOTTORRD NUMERIC(16,6)
DECLARE @CODRIGA1 DECIMAL(5,0)
DECLARE @CODRIGA2 DECIMAL(5,0)
		
		SET @TMP_LOTTORRD = NULL
		--Cerco Per Articolo
		IF (@TIPORIGA = 'AR')
			BEGIN
				SELECT @TMP_LOTTORRD=Lottorrd
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[FunLOTTORIORDINO] TO [Metodo98]
    AS [dbo];

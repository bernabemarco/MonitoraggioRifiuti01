...
SELECT RCONT.NRREG,RCONT.NRRIGA,TCONT.PROGRESSIVO,
    ...
    CAST(YEAR(TCONT.DATAREG) AS VARCHAR(4)) + '-' + SUBSTRING('01-GEN02-FEB03-MAR04-APR05-MAG06-GIU07-LUG08-AGO09-SET10-OTT11-NOV12-DIC',(Month(TCONT.DATAREG)-1)*6+1,6) AS Mese 
FROM 
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[VISTAMOVCONT] TO [Metodo98]
    AS [dbo];

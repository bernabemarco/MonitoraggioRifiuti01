CREATE VIEW VISTATESTEDOC
  AS SELECT TD.PROGRESSIVO,TD.ESERCIZIO,
    ...
    FROM
    (((((TESTEDOCUMENTI AS TD 
        JOIN PARAMETRIDOC ON TD.TIPODOC=PARAMETRIDOC.CODICE)
    ...
    TABCAMBI AS TCAM
    WHERE (TCAM.CODICE=0) AND (SUPERVISOR = 1 OR 
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[VISTATESTEDOC] TO [Metodo98]
    AS [dbo];

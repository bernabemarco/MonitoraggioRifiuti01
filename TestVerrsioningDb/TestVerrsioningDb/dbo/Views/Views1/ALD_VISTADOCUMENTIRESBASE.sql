...
CREATE VIEW [dbo].ALD_VISTADOCUMENTIRESBASE AS
...
WHERE
	(TCAM.CODICE = 0) AND USERDB = CAST(USER_NAME() AS VARCHAR(25)) AND (ANAGRAFICARISERVATICF.ESERCIZIO = TD.ESERCIZIO)
    AND (SUPERVISOR = 1 OR 
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[ALD_VISTADOCUMENTIRESBASE] TO [Metodo98]
    AS [dbo];

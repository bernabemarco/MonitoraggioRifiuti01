CREATE VIEW BudVistaDatiBudgetVariante3 AS 
    SELECT Stagione, (SELECT Descrizione FROM BudTabStagione WHERE Codice = Stagione) AS DesStagione, 
           ...
           Modello, (SELECT Descrizione FROM AnagraficaArticoli WHERE Codice = BudBudgetModelloVariante3.Modello) AS DesModello, 
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[BudVistaDatiBudgetVariante3] TO [Metodo98]
    AS [dbo];

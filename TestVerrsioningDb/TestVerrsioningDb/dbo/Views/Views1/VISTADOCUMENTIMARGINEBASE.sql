...
CREATE VIEW VISTADOCUMENTIMARGINEBASE AS
SELECT TD.PROGRESSIVO AS IDTESTA, TD.ESERCIZIO,TD.DATARIFDOC,
   ...
   RD.RIFRELAZIONECF, RD.UBICAZIONE AS UBICAZIONE, RD.UBICAZIONECOLL AS UBICAZIONECOLL
FROM 
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[VISTADOCUMENTIMARGINEBASE] TO [Metodo98]
    AS [dbo];

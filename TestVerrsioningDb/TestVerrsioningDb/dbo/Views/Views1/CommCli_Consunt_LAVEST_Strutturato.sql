...
CREATE VIEW CommCli_Consunt_LAVEST_Strutturato as
SELECT 
        VB.RIFCOMMCLI,
        VB.TIPOASSEGNAZIONE,
...
WHERE
        VR.TIPOREC IN ('R1','R2','R3','RM') 

GO
GRANT SELECT
    ON OBJECT::[dbo].[CommCli_Consunt_LAVEST_Strutturato] TO [Metodo98]
    AS [dbo];

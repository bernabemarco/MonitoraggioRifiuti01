...
CREATE VIEW TP_VISTATESTEDOC_EXPORT AS 
			...
			(
				(
					(
						...
						JOIN TP_ESPORTATI_EXPORT AS TE On TD.PROGRESSIVO = TE.PROGRESSIVO)
...
GO
GRANT DELETE
    ON OBJECT::[dbo].[TP_VISTATESTEDOC_EXPORT] TO [Metodo98]
    AS [dbo];

CREATE VIEW [dbo].[TP_VISTASCTLOGSCATCTRVAL]
AS
SELECT      TP_TESTE_SCONTI_LOGISTICICTR.DADATA, TP_TESTE_SCONTI_LOGISTICICTR.ADATA, 
                      ...
                      TP_RIGHE_SCONTI_LOGISTICI_CATEGORIASTATCTR.UM, TP_RIGHE_SCONTI_LOGISTICI_CATEGORIASTATCTR.VALORE, 
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[TP_VISTASCTLOGSCATCTRVAL] TO [Metodo98]
    AS [dbo];

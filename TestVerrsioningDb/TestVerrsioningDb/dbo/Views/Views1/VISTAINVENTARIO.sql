...
SELECT STMAG.BIS,
    ...
    STMAG.ESERCIZIO,
    STMAG.RESO,
    (SELECT UM FROM ARTICOLIUMPREFERITE WHERE CODART=STMAG.CODART AND TIPOUM=1) AS UM1,
    (SELECT UM FROM ARTICOLIUMPREFERITE WHERE CODART=STMAG.CODART AND TIPOUM=2) AS UM2,
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[VISTAINVENTARIO] TO [Metodo98]
    AS [dbo];

CREATE VIEW [dbo].[TP_VISTASCTLOGGRPVAL]
AS
SELECT     TP_TESTE_SCONTI_LOGISTICI.PROGRESSIVO, TP_TESTE_SCONTI_LOGISTICI.DADATA, TP_TESTE_SCONTI_LOGISTICI.ADATA, 
                      ...
                      TP_RIGHE_SCONTI_LOGISTICI_GRUPPO.UM, TP_RIGHE_SCONTI_LOGISTICI_GRUPPO.VALORE, 
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[TP_VISTASCTLOGGRPVAL] TO [Metodo98]
    AS [dbo];

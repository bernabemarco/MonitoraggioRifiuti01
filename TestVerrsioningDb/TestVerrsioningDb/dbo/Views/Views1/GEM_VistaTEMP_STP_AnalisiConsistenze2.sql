...
CREATE VIEW [dbo].[GEM_VistaTEMP_STP_AnalisiConsistenze2]
AS
...
FROM         GEM_SEZIONICONTRATTODETTMEZZI AS SCDM INNER JOIN
                      GEM_TEMP_STP_AnalisiConsistenze2 tempAC ON SCDM.IDCONTRATTO = tempAC.IDCONTRATTO AND 
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[GEM_VistaTEMP_STP_AnalisiConsistenze2] TO [Metodo98]
    AS [dbo];

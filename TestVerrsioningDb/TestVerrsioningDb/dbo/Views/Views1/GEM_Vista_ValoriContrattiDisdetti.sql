...
CREATE VIEW [dbo].[GEM_Vista_ValoriContrattiDisdetti]
AS
SELECT  
tc.RIFCOMMCLI,
   year(tc.DATAPVISITA) PrimoEserciziocontratto, 
...
TC.RINNOVOAUT,
 TC.CODCLIENTE, TC.IdStato,  tc.DataIdStato, TC.CodAgente1, TC.CodAgente2, TC.CodAgente3, SC.SEZIONECONTRATTO, 
                      SC.DESCRIZIONESEZIONE, SC.CODDEST, SC.idTipologMezzo, SC.CodiceMezzo, SC.ImportoContrattoSezione, SC.ImportoVisita, SCDM.CodMezzo AS Articolo, 
...
WHERE     (ISNULL(SCDM.ELIMINATO, '0') = '0') AND (MODFAT.FatturaRateale = 0) AND (TC.IdStato = 4) AND (ISNULL(SC.FLAG_ELIMINATO, '0') = '0') AND 
                      (ISNULL(TC.FLAG_ELIMINATO, '0') = '0') OR
                      (MODFAT.FatturaRateale = 0) AND (TC.IdStato = 4) AND (ISNULL(SC.FLAG_ELIMINATO, '0') = '0') AND (ISNULL(TC.FLAG_ELIMINATO, '0') = '0') AND 
                      (SCDM.ELIMINATO = '') OR
                      (ISNULL(SCDM.ELIMINATO, '0') = '0') AND (MODFAT.FatturaRateale = 0) AND (TC.IdStato = 4) AND (ISNULL(TC.FLAG_ELIMINATO, '0') = '0') AND 
                      (SC.FLAG_ELIMINATO = '') OR
                      (MODFAT.FatturaRateale = 0) AND (TC.IdStato = 4) AND (ISNULL(TC.FLAG_ELIMINATO, '0') = '0') AND (SCDM.ELIMINATO = '') AND (SC.FLAG_ELIMINATO = '') OR
                      ...
                      (MODFAT.FatturaRateale = 0) AND (TC.IdStato = 4) AND (ISNULL(SC.FLAG_ELIMINATO, '0') = '0') AND (SCDM.ELIMINATO = '') AND (TC.FLAG_ELIMINATO = '') OR
                      (ISNULL(SCDM.ELIMINATO, '0') = '0') AND (MODFAT.FatturaRateale = 0) AND (TC.IdStato = 4) AND (SC.FLAG_ELIMINATO = '') AND (TC.FLAG_ELIMINATO = '') OR
                      (MODFAT.FatturaRateale = 0) AND (TC.IdStato = 4) AND (SCDM.ELIMINATO = '') AND (SC.FLAG_ELIMINATO = '') AND (TC.FLAG_ELIMINATO = '') OR
                      (ISNULL(SCDM.ELIMINATO, '0') = '0') AND (MODFAT.FatturaRateale = 0) AND (TC.IdStato = 4) AND (ISNULL(SC.FLAG_ELIMINATO, '0') = '0') AND 
                      (TC.FLAG_ELIMINATO = 'N') OR
                      (MODFAT.FatturaRateale = 0) AND (TC.IdStato = 4) AND (ISNULL(SC.FLAG_ELIMINATO, '0') = '0') AND (SCDM.ELIMINATO = '') AND (TC.FLAG_ELIMINATO = 'N') OR
                      (ISNULL(SCDM.ELIMINATO, '0') = '0') AND (MODFAT.FatturaRateale = 0) AND (TC.IdStato = 4) AND (SC.FLAG_ELIMINATO = '') AND (TC.FLAG_ELIMINATO = 'N') OR
                      (MODFAT.FatturaRateale = 0) AND (TC.IdStato = 4) AND (SCDM.ELIMINATO = '') AND (SC.FLAG_ELIMINATO = '') AND (TC.FLAG_ELIMINATO = 'N')


GROUP BY tc.RIFCOMMCLI, tc.DATAPVISITA, TC.IDCONTRATTO, 
...
TC.CODCLIENTE, TC.IdStato,  tc.DataIdStato, TC.CodAgente1, TC.CodAgente2, TC.CodAgente3, 
					  ...
					  tc.PCONTR, tc.CONTRORIG, tc.RIN_PCONTR
UNION ALL
SELECT  tc.RIFCOMMCLI,  year(tc.DATAPVISITA) PrimoEserciziocontratto
...
AND (TC.IdStato = 4) AND (ISNULL(TC.FLAG_ELIMINATO, '0') 
                      = '0') OR
                      (MODFAT.FatturaRateale = 1) AND (TC.IdStato = 4) AND (TC.FLAG_ELIMINATO = '') OR
                      (MODFAT.FatturaRateale = 1) AND (TC.IdStato = 4) AND (TC.FLAG_ELIMINATO = 'N')
GROUP BY tc.RIFCOMMCLI, tc.DATAPVISITA, 
...
GO
GRANT DELETE
    ON OBJECT::[dbo].[GEM_Vista_ValoriContrattiDisdetti] TO [Metodo98]
    AS [dbo];

...
SELECT     TP_TESTE_SCONTI_LOGISTICI.PROGRESSIVO,  TP_TESTE_SCONTI_LOGISTICI.DADATA, TP_TESTE_SCONTI_LOGISTICI.ADATA, 
                      ...
                      TP_RIGHE_SCONTI_LOGISTICI_PREZZIMAG.QTAMIN, TP_RIGHE_SCONTI_LOGISTICI_PREZZIMAG.SCONTO
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[TP_VISTASCTLOGGPM] TO [Metodo98]
    AS [dbo];

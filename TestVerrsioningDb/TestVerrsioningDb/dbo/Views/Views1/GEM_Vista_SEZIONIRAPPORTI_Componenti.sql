...
create view [dbo].[GEM_Vista_SEZIONIRAPPORTI_Componenti]
as
select  t1.*,
...
from    (GEM_SEZIONERAPPORTI_Componenti t1 
...
GO
GRANT DELETE
    ON OBJECT::[dbo].[GEM_Vista_SEZIONIRAPPORTI_Componenti] TO [Metodo98]
    AS [dbo];

...
CREATE VIEW VISTAGESTIONEPREZZITRASFORMAZIONE AS 
SELECT  GP.PROGRESSIVO, GP.CODGRUPPOPREZZICF, 
        GP.CODCLIFOR, GP.CODART, GP.CODGRUPPOPREZZIMAG, 
        GPR.QTAMINIMA, GPR.UM, GP.INIZIOVALIDITA, 
        GP.FINEVALIDITA, GP.USANRLISTINO, GP.TIPOARROT, 
        GP.ARROTALIRE, GP.ARROTAEURO, GPR.PREZZO_MAGG, GPR.PREZZO_MAGGEURO, 
        GPR.TIPO, GPR.SCONTO_UNICO, GPR.SCONTO_AGGIUNTIVO, 
        GPR.NRLISTINO, GP.CODARTRIC,GP.CODFEATURE,GP.VARESPLICITE,  
    ...
    FROM 
        GESTIONEPREZZITRASF GP INNER JOIN GESTIONEPREZZIRIGHETRASF GPR ON GP.PROGRESSIVO = GPR.RIFPROGRESSIVO



GO
GRANT SELECT
    ON OBJECT::[dbo].[VISTAGESTIONEPREZZITRASFORMAZIONE] TO [Metodo98]
    AS [dbo];
